...
avr-gcc -MMD -c -D__PROG_TYPES_COMPAT__ -save-temps=obj -mmcu=atmega2560 -DF_CPU=16000000L -DARDUINO=187 -DARDUINO_ARCH_AVR -Wall -std=gnu11 -fdiagnostics-color=always clock.c -o build-mega-atmega2560/clock.c.o
